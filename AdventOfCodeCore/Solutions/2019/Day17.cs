...
namespace AdventOfCode2019.Solutions
{
    class Day17
    {
        ...
        public long Problem1(string input)
        {
            ...
            var junctions = scaffold.Where(it => it.GetSurrounding4().All(s => scaffold.Contains(s))).ToArray();
        ...
        public long Problem2(string input)
        {
            ...
            //var xLimit = scaffold.Max(it => it.X);
            //var yLimit = scaffold.Max(it => it.Y);

            //for(var yi = 0; yi <= yLimit + 1; yi++)
            //{
            //    var line = new StringBuilder();

            //    for(var xi = 0; xi < xLimit + 1; xi++)
            //    {
            //        var point = new Point(xi, yi);
            //        if (robot == point)
            //            line.Append('X');
            //        else if (scaffold.Contains(point))
            //            line.Append('#');
            //        else
            //            line.Append('.');
            //    }
        ...
        private TurnAndStep[] MapPath(HashSet<Point> scaffold, Point robot, Direction robotDir)
        {
            ...
            var current = null as TurnAndStep;
        ...
        private class TurnAndStep
        {
            ...
            {
                return Turn == input.Turn && Step == input.Step && input.Mark == string.Empty;
            }
