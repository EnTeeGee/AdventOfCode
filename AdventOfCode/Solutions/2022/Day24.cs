...
namespace AdventOfCode.Solutions._2022
{
    class Day24
    {
        ...
        public int Solution1(string input)
        {
            ...
            var target = new Point(lines[0].Length - 3, lines.Length - 2);
            ...
            while (true)
            {
                ...
                foreach(var item in positions)
                {
                    ...
                    if (options.Any(it => it.Equals(target)))
                        return round;

                    options = options.Concat(new[] { item })
                        .Where(it => it.WithinBounds(0, limit.X, 0, limit.Y))
        ...
        public int Solution2(string input)
        {
            ...
            var targets = new[]
            {
                new Point(lines[0].Length - 3, lines.Length - 2),
                new Point(0, -1),
                new Point(lines[0].Length - 3, lines.Length - 2)
            };
